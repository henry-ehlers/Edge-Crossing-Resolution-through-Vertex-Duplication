...
# E
edges = [np.array([0.83751963, 0.1294832 ]), np.array([0.38930045, 0.3271561 ]), np.array([0.02491505, 0.86264701]), np.array([-0.31937688,  0.39418039]), np.array([-0.34114342, -0.40476761]), np.array([-0.25226198, -0.84834848]), np.array([ 0.06051318, -0.42034501]), np.array([ 0.66810389, -0.44390914])]

#edges = [np.array(point) for point in reversed([(0, 0), (1, 1), (2, 1), (3, 0), (4, 1), (5, 4), (3, 3), (2, 2), (1, 2), (0, 3), (1, 4), (-1, 4), (0, 1)])]
